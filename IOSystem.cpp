...
IOSystem::IOSystem(int L, int B, const char *system_state_path)
    : _blocks_num(L), _block_len(B), _system_state_path(system_state_path),
      _ldisk(NULL) {
  assert(L > 0 && B > 0 && system_state_path);
